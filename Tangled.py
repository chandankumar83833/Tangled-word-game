...
def choose(): 
# list of word 
	words = ['rainbow', 'science', 'board' ,'computer', 'programming', 'mathematics', 'player','condition','reverse','water','python',
	'java','auto','break','case','char','const','continue','default','double','enum','extern','float','for','goto','if','int','long',
	'register','return','short','signed','sizeof','static','struct','switch','typeof','union','unsigned','void','volatile','while',
	'do','else']
